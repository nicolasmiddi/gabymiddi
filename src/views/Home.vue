<template>
  <div>
    <ith-home-component id="home" />
    <ith-servicios-component id="servicios" />
    <ith-portfolio-component id="portfolio" />
    <ith-contacto-component id="contacto" />
  </div>
</template>

<script>
import IthHomeComponent from "@/components/IthHomeComponent.vue";
